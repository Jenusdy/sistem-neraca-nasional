	      				...
	      				<table id="pdb-table-kedua" class="display nowrap" style="width:100%">
	        				...
	        				<tbody>
	        				  <?php for ($i=0; $i < sizeof($pdb_harga_konstan); $i++) { 
	        				  	if($i!=0){
	        				  		echo "<tr><td>".$value->tahun."</td>";
					     			echo "<td>".$pdb_harga_konstan[$i]->pertanian/$pdb_harga_konstan[$i-1]->pertanian."</td>";
	        				  	}
	        				  	
				     			// echo "<td>".(($pdb_harga_konstan[$i]->pertambangan/$pdb_harga_konstan[$i]->pertambangan)-1)*100."</td>";
				     			// echo "<td>".(($pdb_harga_konstan[$i]->industri_pengolahan/$pdb_harga_konstan[$i]->industri_pengolahan)-1)*100."</td>";
				     			// echo "<td>".(($pdb_harga_konstan[$i]->listrik_gas/$pdb_harga_konstan[$i]->listrik_gas)-1)*100."</td>";
				     			// echo "<td>".(($pdb_harga_konstan[$i]->air/$pdb_harga_konstan[$i]->air)-1)*100."</td>";
				     			// echo "<td>".(($pdb_harga_konstan[$i]->konstruksi/$pdb_harga_konstan[$i]->konstruksi)-1)*100."</td>";
				     			// echo "<td>".(($pdb_harga_konstan[$i]->perdagangan/$pdb_harga_konstan[$i]->perdagangan)-1)*100."</td>";
				     			// echo "<td>".(($pdb_harga_konstan[$i]->transportasi_pergudangan/$pdb_harga_konstan[$i]->transportasi_pergudangan)-1)*100."</td>";
				     			// echo "<td>".(($pdb_harga_konstan[$i]->akomodasi_makanminum/$pdb_harga_konstan[$i]->akomodasi_makanminum)-1)*100."</td>";
				     			// echo "<td>".(($pdb_harga_konstan[$i]->informasi_komunikasi/$pdb_harga_konstan[$i]->informasi_komunikasi)-1)*100."</td>";
				     			// echo "<td>".(($pdb_harga_konstan[$i]->jasa_keuangan/$pdb_harga_konstan[$i]->jasa_keuangan)-1)*100."</td>";
				     			// echo "<td>".(($pdb_harga_konstan[$i]->real_estate/$pdb_harga_konstan[$i]->real_estate)-1)*100."</td>";
				     			// echo "<td>".(($pdb_harga_konstan[$i]->jasa_perusahaan/$pdb_harga_konstan[$i]->jasa_perusahaan)-1)*100."</td>";
				     			// echo "<td>".(($pdb_harga_konstan[$i]->administrasi_pemerintahan/$pdb_harga_konstan[$i]->administrasi_pemerintahan)-1)*100."</td>";
				     			// echo "<td>".(($pdb_harga_konstan[$i]->jasa_pendidikan/$pdb_harga_konstan[$i]->jasa_pendidikan)-1)*100."</td>";
				     			// echo "<td>".(($pdb_harga_konstan[$i]->jasa_kesehatan/$pdb_harga_konstan[$i]->jasa_kesehatan)-1)*100."</td>";
				     			// echo "<td>".(($pdb_harga_konstan[$i]->jasa_lainnya/$pdb_harga_konstan[$i]->jasa_lainnya)-1)*100."</td>";
				     			// echo "<td>".(($pdb_harga_konstan[$i]->pajak_subsidi/$pdb_harga_konstan[$i]->pajak_subsidi)-1)*100."</td></tr>";
	        				  } 
	        				  ?>
