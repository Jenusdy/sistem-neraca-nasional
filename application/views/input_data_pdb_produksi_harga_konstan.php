		...
		<div class="col s12">
			<div class="card white">
				<div class="card-content">
					<span class="card-title light-green-text text-darken-3"><i class="fas fa-pen"></i> Input data PDB Produksi Harga Konstan</span>
					<hr>
					<div class="row" style="margin:0">
						<form class="col s12" method="POST" action="<?php echo base_url('home/insert_data_pdb_produksi_harga_konstan');?>" style="margin:0;padding:0">
							<div class="row" style="margin:0">
