	...
	<div class="col s12">
		<div class="card white">
			<div class="card-content">
				<span class="card-title light-green-text text-darken-3"><i class="fas fa-table"></i> PDB Produksi Indonesia Atas Dasar Harga Berlaku (Rp Milyar)</span>
				<hr>
			...
			<div class="grey lighten-4 card-action">
				<a href="<?php echo base_url('home/output_pdb_produksi_harga_berlaku');?>" class="light-green waves-effect waves-light btn"><i class="far fa-newspaper right"></i>Generate Output</a>
				<a href="<?php echo base_url('home/input_data_pdb_produksi_harga_berlaku');?>" class="light-green waves-effect waves-light btn"><i class="fas fa-plus right"></i>Tambah data</a>
...
<script type="text/javascript">
  ...
  title: {
    text: 'Grafik PDB Produksi Indonesia Atas Dasar Harga Berlaku (Rp Milyar)'
  },
  xAxis: {
    type: 'category',
    labels: {
